USE ProjEmp;
INSERT INTO employee values(1,'Jack','50000','+919162503897',3,NULL,1);
...
UPDATE project SET project_title='RYZ' WHERE project_id=1;
UPDATE designation SET designation='Project Manager' WHERE designation='Manager';
